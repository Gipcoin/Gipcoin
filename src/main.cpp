...
int64 nChainStartTime = 1482313932;
...
const string strMessageMagic = "Goldingotpoint Signed Message:\n";
...
int64 GetProofOfStakeReward(int64 nCoinAge, unsigned int nBits, unsigned int nTime, int nHeight)
{
	...
	nRewardCoinYear = 0.01 * MAX_MINT_PROOF_OF_STAKE;
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in Goldingotpoint
    bool fStrictPayToScriptHash = true; // Always active in Goldingotpoint
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Goldingotpoint", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "CBigNum vector empty maspac ingIndex Goldingotpoint";
        CTransaction txNew;
        ...
        block.nNonce   = !fTestNet ? 361183 : 361183;
		...
		block.print();
		assert(block.hashMerkleRoot == uint256("0xb18f573b6903a4c69eecd0e93015e4530ed92adfad1234beee2172a86f132524"));
...
unsigned char pchMessageStart[4] = { 0xd6, 0xf1, 0xa8, 0xbd };
