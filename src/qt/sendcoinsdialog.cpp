    ...
    model(0)
{
    ...
    ui->sendButton->setIcon(QIcon());
     ...
     ui->lineEditCoinControlChange->setPlaceholderText(tr("Enter a Goldingotpoint address"));
#endif
     ...
     if (model)
     {
        ...
        if (text.isEmpty())
         ...
         else if (!CBitcoinAddress(text.toStdString()).IsValid())
         {
             ...
             ui->labelCoinControlChangeLabel->setText(tr("WARNING: Invalid Goldingotpoint address"));
         }
         else
         {
